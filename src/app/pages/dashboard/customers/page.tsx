...
export default function CustomersPage() {
  ...
  return (
    <MasterDataManager
      title="Customers"
      description="Manage your customers and their preferences, like billing place and currency."
      addLabel="Add Customer"
      emptyTitle="No customers yet"
      emptyDescription="Add your first customer to reuse their details across forms."
