...
const sealVariant: Record<DeliveryNoteStatus, { color: string; borderColor: string }> = {
  draft: { color: "#64748b", borderColor: "#94a3b8" },
  sent: { color: "#2563eb", borderColor: "#3b82f6" },
  delivered: { color: "#059669", borderColor: "#10b981" },
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            ...
            <Text style={styles.headerMeta}>#{data.dnNo}</Text>
        ...
        <View style={styles.section}>
          <View style={styles.grid}>
            <View style={styles.partyBlock}>
              ...
              <Text style={styles.value}>{data.deliverTo.name || "-"}</Text>
              {data.deliverTo.company ? (
                <Text style={styles.value}>{data.deliverTo.company}</Text>
              ) : null}
              {data.deliverTo.address ? (
                <Text style={styles.value}>{data.deliverTo.address}</Text>
              ) : null}
              {data.deliverTo.email ? (
                <Text style={styles.value}>{data.deliverTo.email}</Text>
              ) : null}
            </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.totals}>
            ...
            <View style={styles.sealWrap}>
              ...
              >
                <Text>{DELIVERY_NOTE_STATUS_LABELS[data.status]}</Text>
              </View>
            </View>
          </View>
        </View>
