    ...
    <div className="relative px-6 py-6 md:px-10 md:py-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="grid grid-cols-2 gap-4">
          <PartyBlock title="Bill To" party={data.billTo} />
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          ...
          <DetailRow
            label="Payment Mode"
            value={PAYMENT_MODE_LABELS[paymentMode]}
          />
        </div>
      </div>
      ...
      <div className="relative mt-6 flex justify-end">
        <div className="w-full max-w-xs space-y-1.5 text-sm">
          ...
          <div className="flex justify-between font-semibold text-emerald-700">
            ...
            <span>{formatMoney(totals.balance, currency)}</span>
          </div>
        </div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        {showBank && (
          <div className="md:col-span-2">
            ...
            <div className="mt-1 grid grid-cols-2 gap-4 text-sm text-gray-700 md:grid-cols-5">
              <div>
              ...
              <div>
                ...
                <p>{data.bank.ifscCode}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400">SWIFT</p>
                <p>{data.bank.swiftCode}</p>
              </div>
            </div>
          </div>
        )}
