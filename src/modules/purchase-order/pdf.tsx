...
const sealVariant: Record<PurchaseOrderStatus, { color: string; borderColor: string }> = {
  draft: { color: "#64748b", borderColor: "#94a3b8" },
  sent: { color: "#2563eb", borderColor: "#3b82f6" },
  approved: { color: "#7c3aed", borderColor: "#8b5cf6" },
  received: { color: "#059669", borderColor: "#10b981" },
...
export function PurchaseOrderDocument({
  ...
  const shipTo = data.sameAsBilling ? data.vendor : data.shipTo;
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            ...
            <Text style={styles.headerMeta}>#{data.poNo}</Text>
            <Text style={styles.statusBadge}>
              {PURCHASE_ORDER_STATUS_LABELS[data.status]}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.grid}>
            <View style={styles.partyBlock}>
              ...
              {data.vendor.company ? (
                <Text style={styles.value}>{data.vendor.company}</Text>
              ) : null}
              {data.vendor.address ? (
        ...
        <View style={styles.section}>
          ...
          <View style={styles.totals}>
            ...
            <View style={styles.sealWrap}>
              ...
              >
                <Text>{PURCHASE_ORDER_STATUS_LABELS[data.status]}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <Text style={styles.footer}>
          This is a system-generated purchase order. Please verify all details
          before ordering.
        </Text>
      </Page>
    </Document>
