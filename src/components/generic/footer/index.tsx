            ...
            <div className="w-full max-w-7xl py-10 md:pt-0 px-4 sm:px-6 lg:px-8 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
                    ...
                    <div className="text-center md:text-end space-x-2">
                        <a className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-black hover:text-gray-600 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:text-neutral-400" href="#">
